...
export default function ProfileVisitNode({
  ...
  return (
    <div className="relative w-72 z-10">
      ...
      <div className="relative w-full rounded-xl border border-gray-200 bg-white shadow-sm overflow-visible">
        {/* Top label + actions */}
        ...
        <div className="flex items-start gap-3 px-4 pb-3">
          <div className="bg-indigo-100 rounded-full p-2">
            <Eye className="w-4 h-4 text-indigo-600" strokeWidth={2} />
          </div>
